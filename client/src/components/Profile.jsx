...
const Profile = () => {
  ...
  const handleUpdateClick = async () => {
    setIsUpdating(true); // Disable the button and show loading state
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/api/v1/user/profile",
        {
          ...
          body: JSON.stringify(profile), // Send the updated profile data
        }
      );
        ...
        profile && (
          <div className="container">
            <div className="profile-status">
              <div className="txt">
                <h1 className="text-5xl bg-blue-200 text-black text-center">
                  Personal Details
                </h1>
              </div>
              <div className="details">
                ...
                />
                <br />
                <label className="label-txt" htmlFor="mobile">
                  Mobile
                </label>
                <input
                  className="input-txt"
                ...
                />
                <br />
                <label className="label-txt" htmlFor="address">
                  Address
                </label>
                <input
                  className="input-txt h-40 w-64 outline-none"
                  type="text"
                  placeholder="Address"
